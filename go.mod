...
require (
	...
	github.com/Herrscherd/herrscher-contracts v0.2.9
	...
	github.com/Herrscherd/herrscher-obsidian-memory v0.2.7
	github.com/Herrscherd/herrscher-orchestrator v0.1.12
