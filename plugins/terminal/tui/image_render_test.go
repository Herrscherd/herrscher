...
func TestRenderEntryEmitsPreviewUnderChip(t *testing.T) {
	...
	withPreview := renderEntry(entry{role: roleYou, text: "look", attachments: []Attachment{att}, preview: preview}, 40, view{})
	...
	without := renderEntry(entry{role: roleYou, text: "look", attachments: []Attachment{att}}, 40, view{})
